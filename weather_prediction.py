...
# Example: Predicting a single data point
test_value_number = 1
input_data = X[test_value_number].reshape(1, -1)  # Reshape to match input shape
prediction = model_predict_rain.predict(input_data)
print(prediction)
